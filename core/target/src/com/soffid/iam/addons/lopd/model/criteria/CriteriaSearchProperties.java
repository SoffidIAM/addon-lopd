...
public class CriteriaSearchProperties
{
	...
	private static final void initialize1()
	{
		embeddedValuesByType.put(
			com.soffid.iam.addons.lopd.model.RolFitxerEntityImpl.class,
			null);
		navigableAssociationEndsByType.put(
			...
			java.util.Arrays.asList(
				new AssociationType[] 
				{
					new AssociationType("fitxer", com.soffid.iam.addons.lopd.model.FitxerEntityImpl.class),
					new AssociationType("rol", es.caib.seycon.ng.model.RolEntityImpl.class)
				}
			)
		);
	}
	...
	{
		embeddedValuesByType.put(
			com.soffid.iam.addons.lopd.model.AdministradorSeguretatOrganitzatiuFitxerEntityImpl.class,
			null);
		navigableAssociationEndsByType.put(
			com.soffid.iam.addons.lopd.model.AdministradorSeguretatOrganitzatiuFitxerEntityImpl.class,
			java.util.Arrays.asList(
				...
				{
					new AssociationType("fitxer", com.soffid.iam.addons.lopd.model.FitxerEntityImpl.class),
					new AssociationType("administradorDeSeguretatOrganitzatiu", es.caib.seycon.ng.model.UsuariEntityImpl.class)
				}
			)
		);
	}
	...
	{
		embeddedValuesByType.put(
			com.soffid.iam.addons.lopd.model.ResponsableSeguretatOrganitzatiuFitxerEntityImpl.class,
			null);
		navigableAssociationEndsByType.put(
			com.soffid.iam.addons.lopd.model.ResponsableSeguretatOrganitzatiuFitxerEntityImpl.class,
			java.util.Arrays.asList(
				...
				{
					new AssociationType("fitxer", com.soffid.iam.addons.lopd.model.FitxerEntityImpl.class),
					new AssociationType("responsableSeguretatOrganitzatiu", es.caib.seycon.ng.model.UsuariEntityImpl.class)
				}
			)
		);
	}
	...
	{
		embeddedValuesByType.put(
			com.soffid.iam.addons.lopd.model.FitxerEntityImpl.class,
			null);
		navigableAssociationEndsByType.put(
			com.soffid.iam.addons.lopd.model.FitxerEntityImpl.class,
			java.util.Arrays.asList(
				new AssociationType[] 
				{
					new AssociationType("responsable", es.caib.seycon.ng.model.UsuariEntityImpl.class),
					new AssociationType("direccioGeneral", es.caib.seycon.ng.model.GrupEntityImpl.class),
					new AssociationType("rolFitxers", com.soffid.iam.addons.lopd.model.RolFitxerEntityImpl.class),
					new AssociationType("responsableSeguretatTecnic", es.caib.seycon.ng.model.UsuariEntityImpl.class),
					new AssociationType("administradorSeguretatOrganitzatiuUsuariFromFitxer", com.soffid.iam.addons.lopd.model.AdministradorSeguretatOrganitzatiuFitxerEntityImpl.class),
					new AssociationType("responsableSeguretatOrganitzatiuUsuariFromFitxer", com.soffid.iam.addons.lopd.model.ResponsableSeguretatOrganitzatiuFitxerEntityImpl.class)
				}
			)
		);
	}
